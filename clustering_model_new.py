...
if __name__=="__main__":
    ...
    with open('selected_features_1.pkl', 'wb') as f:
    ...
    joblib.dump(pca, 'pca_model_1.pkl')
    ...
    from sklearn.metrics import silhouette_score
    silhouette_avg = silhouette_score(tumor_pca, cluster.labels_)
    print(f'Silhouette Score: {silhouette_avg}')

    from sklearn.metrics import davies_bouldin_score
    db_index = davies_bouldin_score(tumor_pca, cluster.labels_)
    print(f"Davies-Bouldin Index: {db_index}")

    with open("clustering_metrics.txt", "w") as file:
    ...
    #save the model
    joblib.dump(cluster, 'kmeans_model_1.pkl')
